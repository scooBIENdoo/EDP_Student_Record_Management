...
Public Class Form3
    ...
    Private Sub btn_print_record_2_Click(sender As Object, e As EventArgs) Handles btn_print_record_2.Click
        Print.PrintToExcel(DataGridView2)
    End Sub

    Private Sub btn_upload_2_Click(sender As Object, e As EventArgs) Handles btn_upload_2.Click
    ...
    Private Sub btn_backup_data_2_Click(sender As Object, e As EventArgs) Handles btn_backup_data_2.Click
    ...
    Private Sub btn_locate_data_2_Click(sender As Object, e As EventArgs) Handles btn_locate_data_2.Click
